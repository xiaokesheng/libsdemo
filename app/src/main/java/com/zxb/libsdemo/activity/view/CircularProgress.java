...
public class CircularProgress extends View {
    ...
    private boolean isInPercentage = false;
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        mColors = new int[4];
        mColors[0] = Color.parseColor("#38a2ff");
        mColors[1] = Color.parseColor("#38a2ff");
        mColors[2] = Color.parseColor("#38a2ff");
        mColors[3] = Color.parseColor("#38a2ff");
    ...
    public void draw(Canvas canvas) {
        super.draw(canvas);
        if (isInPercentage) {
            canvas.drawArc(fBounds, -90, percentage / 100f * 360, false, mPaint);
        } else {
