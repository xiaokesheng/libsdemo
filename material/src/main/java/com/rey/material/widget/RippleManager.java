...
public final class RippleManager implements View.OnClickListener {
    ...
    public void onCreate(View v, Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (rippleStyle != 0) {
            Log.e("rippleStyle", "rippleStyle != 0");
            ...
            Log.e("rippleStyelEnable", String.valueOf(rippleEnable));
    ...
    private Drawable getBackground(View v) {
        ...
        if (background == null) {
            Log.e("background", "null");
            return null;
        }

        if (background instanceof RippleDrawable) {
            Log.e("background", "instance of RippleDrawable");
            return ((RippleDrawable) background).getBackgroundDrawable();
        }

        Log.e("background", "normalBackground");
...
//                Log.e("background", "instance of ToolbarRippleDrawable");
